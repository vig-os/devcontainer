...
check_spec = importlib.util.spec_from_file_location(
    "check_action_pins", scripts_dir / "check_action_pins.py"
)
check_module = importlib.util.module_from_spec(check_spec)
check_spec.loader.exec_module(check_module)

check_file = check_module.check_file
find_workflow_files = check_module.find_workflow_files
main = check_module.main
SHA_PATTERN = check_module.SHA_PATTERN
USES_PATTERN = check_module.USES_PATTERN
