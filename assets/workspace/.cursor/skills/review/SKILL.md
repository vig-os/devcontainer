...
- If only Minor issues, note them and proceed to [submit-pr](../submit-pr/SKILL.md).

## Important Notes

- Run this before every PR submission. The [submit-pr](../submit-pr/SKILL.md) workflow should reference this as a prerequisite.
