...
- Problem is already well-articulated (jump to [inception:scope](../inception:scope/SKILL.md))
...
**If continue:** Proceed to [inception:scope](../inception:scope/SKILL.md)
...
After user approval, invoke [inception:scope](../inception:scope/SKILL.md) to define what to build.
