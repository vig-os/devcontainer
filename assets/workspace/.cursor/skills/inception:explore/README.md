...
- Problem and solution are already clear (use [issue:create](../issue:create/) and [design:brainstorm](../design:brainstorm/) directly)
...
1. Use [issue:claim](../issue:claim/) to start work on an issue
2. Each issue goes through [design:brainstorm](../design:brainstorm/) → [code:execute](../code:execute/) workflow
