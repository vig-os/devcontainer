...
4. If the branch does not match, **stop** and tell the user:
   ...
   - Offer to run [start-issue](../claim-issue/SKILL.md) to create one.
...
4. If no comment contains `## Implementation Plan`, **stop** and tell the user to run [plan](../plan/SKILL.md) first.
...
- Diagnose using [debug](../debug/SKILL.md) principles if needed.
...
- Report final status.
- Suggest committing and proceeding to [submit-pr](../submit-pr/SKILL.md).
