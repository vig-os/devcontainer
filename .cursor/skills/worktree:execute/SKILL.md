...
Work through an implementation plan **without user checkpoints**. This is the worktree variant of [code:execute](../code:execute/SKILL.md). Progress is tracked in the GitHub issue comment.
...
3. If no plan exists, invoke [worktree:plan](../worktree:plan/SKILL.md) first.
...
- If genuinely stuck after 2-3 attempts, use [worktree:ask](../worktree:ask/SKILL.md) to post a question on the issue.
