...
Break an approved design into implementation tasks **without user interaction**. This is the worktree variant of [design:plan](../design:plan/SKILL.md).
...
- If no `## Design` comment exists, invoke [worktree:brainstorm](../worktree:brainstorm/SKILL.md) first.
