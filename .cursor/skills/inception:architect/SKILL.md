...
Use this skill when:
- Solution scope is defined (from [inception:scope](../inception:scope/SKILL.md))
...
- It's an extension of existing patterns (use [design:brainstorm](../design:brainstorm/SKILL.md) instead)
...
**If continue:** Proceed to [inception:plan](../inception:plan/SKILL.md)
...
After user approval, invoke [inception:plan](../inception:plan/SKILL.md) to decompose into GitHub issues.
