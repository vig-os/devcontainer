...
milestone: none
projects: none
synced: 2026-04-30T05:36:17.944Z
---

# [PR 539](https://github.com/vig-os/devcontainer/pull/539) build(pip): update python to v3.14.4

This PR contains the following updates:

| Package | Type | Update | Change |
|---|---|---|---|
| [python](https://python.org) ([source](https://redirect.github.com/python/cpython)) | requires-python | minor | `==3.12.10` → `==3.14.4` |
