...
updated: 2026-07-09T14:38:53Z
author: gerchowl
author_url: https://github.com/gerchowl
url: https://github.com/vig-os/devkit/pull/548
comments: 1
labels: none
assignees: none
milestone: none
projects: none
synced: 2026-07-11T13:34:56.024Z
---

# [PR 548](https://github.com/vig-os/devkit/pull/548) feat: in-container Tailscale SSH support (#85)
...
## [Comment #1](https://github.com/vig-os/devkit/pull/548#issuecomment-4875991068) by [@c-vigo](https://github.com/c-vigo)

_Posted on July 3, 2026 at 12:09 PM_

Closing as stale: this branch predates the Nix migration (#625) and targets pre-migration `main`; the sidecar/compose surface it touched was since removed (#799) and the image is now Nix-built (#634). The feature itself stays tracked in #85 (Backlog) — a fresh implementation on top of the Nix image is the viable path.
...
### Commit 1: [d077ab5](https://github.com/vig-os/devkit/commit/d077ab51cb5ac1ef8008bd4579db7e836dba0722) by [gerchowl](https://github.com/gerchowl) on May 15, 2026 at 02:21 PM
feat(image,scripts,docs): in-container Tailscale SSH support (Refs: #85), 617 files modified
